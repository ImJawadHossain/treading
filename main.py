...
with contextlib.redirect_stdout(io.StringIO()):
    model1 = joblib.load("C:\Users\MdJaw\PycharmProjects\Treading\btcbusd_trand_predictor_tf.joblib")

with contextlib.redirect_stdout(io.StringIO()):
    model2 = joblib.load("C:\Users\MdJaw\PycharmProjects\Treading\btcbusd_trand_predictor.joblib")
